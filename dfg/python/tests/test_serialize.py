...
class TestRoundTrip(unittest.TestCase):
    ...
    def test_policies_and_capacities_round_trip(self):
        ...
        builder.connect(
            "head.output", "sink.inp", capacity=8, on_overflow="drop_oldest"
        )
